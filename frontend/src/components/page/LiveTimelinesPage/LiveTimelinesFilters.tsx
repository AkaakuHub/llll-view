...
interface LiveTimelinesFiltersProps {
	searchTerm: string;
...
const LiveTimelinesFilters = ({
	searchTerm,
	onSearchChange,
	musicIdFilter,
	onMusicIdChange,
	musicIdOptions,
}: LiveTimelinesFiltersProps) => {
	return (
				...
				<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
					<div className="flex-1 max-w-md">
						<div className="relative">
							...
							<input
								type="text"
								placeholder="Search by label, ID, or music title..."
								value={searchTerm}
...
export default LiveTimelinesFilters;
